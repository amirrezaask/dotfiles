...
(cond
 ((member "Fira Code" font-families)      (load-font "Fira Code" 15))
 ((member "JetBrains Mono" font-families) (load-font "JetBrains Mono" 15))
...
;; Add support for langauges which Emacs does not support builtin
(install 'go-mode)
(install 'rust-mode)
(install 'php-mode)
(install 'json-mode)
