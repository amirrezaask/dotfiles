...
*** Projectile
   #+BEGIN_SRC elisp
     (use-package projectile
       ...
       :init
       (with-eval-after-load 'evil 
         (evil-define-key 'normal global-map (kbd "SPC SPC") 'projectile-find-file)
...
** Dotfiles
   #+begin_src emacs-lisp
     ...
     (define-key evil-normal-state-map (kbd "SPC ec") 'amirreza/edit-dot-config)
