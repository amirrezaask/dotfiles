...
#+BEGIN_SRC emacs-lisp
  (defvar amirreza/font "Iosevka-11")
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c t") 'amirreza/open-todo)
...
:header-args: :tangle no
:END:
Deprecated, I use my hand rolled project integration block below.
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (require 'cl-lib)
  (use-package project
    :bind (("C-c p f" . amirreza/project-or-dir-find-file-recur)
           ("C-c p s" . amirreza/projects-list)
           ("C-c p l" . amirreza/project-list))
    :config
