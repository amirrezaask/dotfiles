...
* Modules
#+begin_src emacs-lisp
  (defvar amirreza/modules '(selectrum amirreza/modeline dashboard) "List of modules enabled")
  (defun enabled? (mod)
...
#+begin_src emacs-lisp
  ...
  (if-enabled? doom/modeline 
    ...
    (pkg! nyan-mode :straight t :config (nyan-mode 1)))
#+end_src
** Font
#+BEGIN_SRC emacs-lisp
...
#+begin_src emacs-lisp
  (pkg! isearch :defer t)
  (if-enabled? swiper (pkg! swiper :straight t :bind ("C-s" . swiper)))
