...
#+begin_src emacs-lisp
  (use-package project
    ...
    :map evil-normal-state-map ("SPC p f" . amirreza/find-project)
    )
...
#+begin_src emacs-lisp
  ...
  (use-package project
    :bind(("C-c f" . 'amirreza/file-finder)
          ...
          :map evil-normal-state-map
          ("SPC a s" . 'amirreza/find-symbol-at-point)
          ("SPC a f" . 'amirreza/find-file-at-point)
          ("SPC g" . 'amirreza/grep))
    :config
