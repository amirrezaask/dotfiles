...
- [[#basic-setup][Basic Setup]]
  - [[#defer-loading-of-some-internal-packages][Defer loading of some internal packages]]
...
- [[#minibuffer-completion][Minibuffer completion]]
  - [[#icompletedeprecated][Icomplete(Deprecated)]]
  - [[#ivy][Ivy]]
    - [[#ivy-1][Ivy]]
    - [[#counsel][Counsel]]
    - [[#ivy-rich][Ivy-Rich]]
...
#+end_src
* Basic Setup
** Defer loading of some internal packages
#+begin_src emacs-lisp
  (corelib/defer-packages '(help-mode
                            recentf
                            ))
#+end_src
** Tab Setting
...
#+begin_src emacs-lisp
  (use-package project
    :bind ("s-p" . amirreza/projects-list)
    :config
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package lsp-ivy :straight t
    ...
    :bind (("C-s-l f" . lsp-ivy-workspace-symbol)
           ...
           ("C-c m s" . lsp-ivy-workspace-symbol)))
