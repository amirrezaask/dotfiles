...
- [[#keybindings][Keybindings]]
  - [[#keybinding-rules][Keybinding rules]]
...
#+begin_src emacs-lisp
  (use-package counsel
    ...
    :demand
    :config
    :bind (("C-c o m l" . counsel-rhythmbox)
           ("C-c o m c" . (lambda ()
                          (interactive)
...
#+BEGIN_SRC emacs-lisp
  (use-package gotest :defer t :straight t :bind (:map go-mode-map ("C-c m t f" . go-test-current-file) ("C-c m t t" . go-test-current-test)))
#+END_SRC
** Scheme
