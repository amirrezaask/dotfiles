...
#+begin_src emacs-lisp
  ...
  (use-package which-key
    ...
    (which-key! "C-c M" "Music functions")
...
** Dashboard
#+begin_src emacs-lisp
  (use-package page-break-lines :straight t :config (global-page-break-lines-mode))
  (use-package dashboard
    ...
    (setq dashboard-footer-messages '("Free as in free bear"))
...
* Recent files
 #+begin_src emacs-lisp
   (use-package counsel
     ...
     :bind (("C-s-r" . amirreza/recents)
            ("C-c r" . amirreza/recents)))
 #+end_src
* Projectile
#+begin_src emacs-lisp
