...
** Font
   #+BEGIN_SRC elisp
     ...
     (defvar amirreza/font "JetBrainsMono Nerd Font Mono-15")
...
#+begin_src emacs-lisp
  ...
  (define-key evil-normal-state-map (kbd "SPC h f") 'find-file)
  ...
  (with-eval-after-load 'evil (evil-collection-init))
...
*** Pdf tools
    #+BEGIN_SRC elisp
      ...
      (add-hook 'pdf-tools-enabled-hook #'menu-bar-mode)
    #+END_SRC
