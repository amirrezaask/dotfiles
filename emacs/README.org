...
#+begin_src emacs-lisp
  ...
  (use-package general
    :straight t
    :config
    (general-create-definer space-leader :prefix "SPC" :keymaps 'normal)
    (space-leader
      ;; Emacs basics
...
#+BEGIN_SRC emacs-lisp
  (global-set-key (kbd "C-c c e") (lambda () (interactive) (find-file (expand-file-name "README.org" user-emacs-directory))))
#+END_SRC
*** TRAMP
TBA
