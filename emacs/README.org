...
Since Emacs is becoming the only tool I do all my computing in,
...
#+begin_src emacs-lisp
  ...
  (use-package esh-mode
   ...
   (defun amirreza/eshell-recent-dir-search ()
    ...
    ;; Some aliasing
    (eshell/alias 'o 'find-file)
    (eshell/alias 'e 'find-file)
    (eshell/alias 'd (lambda () (dired default-directory)))
    (eshell/alias "ocgp" "oc get pods")

    :bind (:map eshell-mode-map
                ("C-c f c" . amirreza/eshell-show-content-file-at-point)
                ("C-r" . amirreza/eshell-history-search)
                ("C-c f f" . amirreza/eshell-find-file-at-point)
                ("C-c f k" . amirreza/eshell-kill-save-file-at-point)
                ("C-c =" . amirreza/eshell-recent-dir-search)
                ("C-c d" . amirreza/eshell-find-sub-dirs-recur)))
#+end_src
**** VTerm
#+begin_src emacs-lisp
...
***** Python Mode
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package python-mode
      :mode "\\.py\\'"
      :hook (python-mode . amirreza/python-mode-hook)
      :config
