...
#+begin_src emacs-lisp
  (use-package exwm
    ...
    :config
    (require 'exwm-config)
    (exwm-config-default) ;; EXwm default configuration
    (setq exwm-workspace-number 10)) ;; Number of workspaces
#+end_src
* UI
** Themes
...
#+begin_src emacs-lisp
  ...
  (use-package live-completions :straight (:host github :repo "oantolin/live-completions") :config (live-completions-mode 1))
#+end_src
* Windows/Workspaces
** Window rules
