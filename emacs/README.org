...
#+begin_src emacs-lisp
  ...
  (use-package cheatsheet
    ...
    (cheatsheet-add-group 'Common
                          '(:key "C-." :description "Multiple cursors")
                          '(:key "C-s-w" :description "Workspaces")
                          '(:key "C-s-m" :description "Music")
                          '(:key "C-s-d" :description "Docker")
                          '(:key "C-s-k" :description "Kubernetes")
                          '(:key "C-s-f" :description "FZF")
                          '(:key "C-s-g" :description "ripgrep")
                          '(:key "C-s-v" :description "Version control")))
  ...
  (use-package which-key
    ...
    (which-key! "C-c v" "Version control actions")
...
#+BEGIN_SRC emacs-lisp
  (use-package eyebrowse :straight t
    ...
    :bind (("C-c w 0" . eyebrowse-switch-to-window-config-0)
           ...
           ("C-s-w 0" . eyebrowse-switch-to-window-config-0)
           ("C-s-w 1" . eyebrowse-switch-to-window-config-1)
           ("C-s-w 2" . eyebrowse-switch-to-window-config-2)
           ("C-s-w 3" . eyebrowse-switch-to-window-config-3)
           ("C-s-w 4" . eyebrowse-switch-to-window-config-4)
           ("C-s-w 5" . eyebrowse-switch-to-window-config-5)
           ("C-s-w 6" . eyebrowse-switch-to-window-config-6)
           ("C-s-w 7" . eyebrowse-switch-to-window-config-7)
           ("C-s-w 8" . eyebrowse-switch-to-window-config-8)
           ("C-s-w 9" . eyebrowse-switch-to-window-config-9)
...
#+begin_src emacs-lisp
  (require 'cl-lib)
  (use-package project
    :bind (("C-c f" . amirreza/project-or-dir-find-file-recur)
           ("C-s-f" . amirreza/project-or-dir-find-file-recur)
           ("C-s-p" . amirreza/project-list)
...
**** Go-test
 ...
 #+BEGIN_SRC emacs-lisp
   (use-package gotest :straight t 
     :after go-mode
     :config
     (define-key go-mode-map (kbd "C-c m t t") 'go-test-current-file) 
...
#+begin_src emacs-lisp
  (use-package elfeed :straight t
    :commands (elfeed)
    :config
    (setq elfeed-feeds '("https://hckrnews.com/")))
#+end_src
* IRC
#+begin_src emacs-lisp
  (use-package erc 
...
#+begin_src emacs-lisp
  (use-package rhythmbox
    :bind (("C-s-m l" . Rhythmbox)
           ("C-s-m p" . Rhythmbox/play-pause-current-song)
...
* Kubernetes
#+begin_src emacs-lisp
(use-package kubel :straight t :commands (kubel) :bind (("C-c k" . kubel)))
#+end_src
