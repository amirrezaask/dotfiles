...
#+BEGIN_SRC emacs-lisp
  (use-package go-mode
    ...
    (defun amirreza/go-hook ()
      ...
      (amirreza/defsnippet "for" "" "for " _ " := range {" \n \n "}")
      (amirreza/defsnippet "test" "" "func " _ "(t *testing.T) {" \n \n "}")
      (amirreza/defsnippet "hh" "" "func " _ "(w http.ResponseWriter, r *http.Request) {" \n \n "}")
...
#+BEGIN_SRC emacs-lisp
  (use-package elisp-mode
    :init
    (add-hook 'emacs-lisp-mode-hook 'amirreza/elisp-hook)
    :config
