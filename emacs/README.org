...
#+begin_src emacs-lisp
   ...
   (use-package helm-rhythmbox :straight t
     :bind (("<f7>" . helm-rhythmbox)))
...
**** VTerm
     #+BEGIN_SRC emacs-lisp
       (use-package vterm
         :straight t
         :commands vterm
         :bind (("<f10>" . amirreza/open-vterm-vertical))
         :config
         (defun amirreza/open-vterm-vertical ()
           (interactive)
           (split-window-right)
...
#+begin_src emacs-lisp
  (use-package bongo :straight t
    ...
    :bind
    ("<XF86-AudioPlay>" . bongo-pause/resume))
#+end_src
