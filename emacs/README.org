...
There is a bultin Emacs package called abbrev that we can use to define abbrv
that we can use in multiple modes.
#+begin_src emacs-lisp
      (use-package abbrev
        :demand 
        ...
        :config
        (define-abbrev global-abbrev-table "mygit" "https://github.com/amirrezaask"))
#+end_src
*** Rainbow delimiters
