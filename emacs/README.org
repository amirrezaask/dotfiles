...
** Themes
   #+BEGIN_SRC elisp
     (use-package doom-themes
       :straight t
       :init
       (defun amirreza/load-theme (&optional theme)
         (interactive)
         (cond
          ((null theme) (let ((theme (intern  (completing-read "Theme: " (mapcar #'symbol-name
                                                                                 (custom-available-themes))))))
                          (mapc #'disable-theme custom-enabled-themes)
                          (load-theme theme t)))
          (t (load-theme theme t)))))
     (amirreza/load-theme 'doom-dracula)
   #+END_SRC
** Evil
    #+begin_src emacs-lisp
...
** Buffer Management
   #+BEGIN_SRC elisp
     (use-package bufler
       :straight t
       :init
       (with-eval-after-load 'evil (evil-define-key 'normal global-map (kbd "SPC B") 'bufler))
       :bind (("C-x C-b" . 'bufler)))
   #+END_SRC
   ...
   #+begin_src emacs-lisp
     (use-package perspective
       ...
       (with-eval-after-load 'evil 
         (evil-define-key 'normal global-map (kbd "SPC ps") 'persp-switch)
         (evil-define-key 'normal global-map (kbd "SPC pn") 'persp-next))
       :custom
...
*** Projectile
   #+BEGIN_SRC elisp
     (use-package projectile
       ...
       :bind
       (("C-x p f" . amirreza/find-project)
        ("C-x C-f" . amirreza/find-file)
       ...
       (with-eval-after-load 'evil 
         ...
         (evil-define-key 'normal global-map (kbd "SPC p p") 'amirreza/find-project))
...
** Dotfiles
   #+begin_src emacs-lisp
     ...
     (with-eval-after-load 'evil (define-key evil-normal-state-map (kbd "SPC ec") 'amirreza/edit-dot-config))
