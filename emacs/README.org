...
- [[#chapters][Chapters]]
  ...
  - [[#windowsworkspaces][Windows/Workspaces]]
    ...
    - [[#beacon][Beacon]]
    - [[#window-manager-hydra][Window Manager Hydra]]
...
#+BEGIN_SRC emacs-lisp
    (use-package eyebrowse :ensure t
      ...
      (pretty-hydra-define eyebrowse-hydra (:hint nil)
        ("Workspaces"
          (("0" eyebrowse-switch-to-window-config-0)
          ("1" eyebrowse-switch-to-window-config-0)
          ("2" eyebrowse-switch-to-window-config-0)
          ("3" eyebrowse-switch-to-window-config-0)
          ("4" eyebrowse-switch-to-window-config-0)
          ("5" eyebrowse-switch-to-window-config-0)
          ("6" eyebrowse-switch-to-window-config-0)
          ("7" eyebrowse-switch-to-window-config-0)
          ("8" eyebrowse-switch-to-window-config-0)
          ("9" eyebrowse-switch-to-window-config-0))
...
#+begin_src emacs-lisp
    (pretty-hydra-define amirreza-window-manager-hydra (:hint nil)
      ("Movements"
       (("u" windmove-up "Up")
       ...
       (("a" ace-window "Ace window")
        ...
        ("z" delete-other-windows "Zoom in current window")
        ("u" winner-undo "Back to previous window configuration"))))

  (global-set-key (kbd "C-x o") 'amirreza-window-manager-hydra/body)
  (global-set-key (kbd "C-x C-o") 'amirreza-window-manager-hydra/body)
...
*** Music
  I need music when I am working, so for me music is just a part of development environment.
  #+begin_src emacs-lisp
    (use-package counsel
      :ensure t
      :demand
