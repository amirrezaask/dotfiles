...
#+BEGIN_SRC emacs-lisp
  (use-package eyebrowse :straight t
    ...
    (defhydra eyebrowse-hydra (global-map "C-c w")
      "Eyebrowse workspaces"
      ("0" eyebrowse-switch-to-window-config-0 "Switch to workspace 0")
      ("1" eyebrowse-switch-to-window-config-1 "Switch to workspace 1")
      ("2" eyebrowse-switch-to-window-config-2 "Switch to workspace 2")
      ("3" eyebrowse-switch-to-window-config-3 "Switch to workspace 3")
      ("4" eyebrowse-switch-to-window-config-4 "Switch to workspace 4")
      ("5" eyebrowse-switch-to-window-config-5 "Switch to workspace 5")
      ("6" eyebrowse-switch-to-window-config-6 "Switch to workspace 6")
      ("7" eyebrowse-switch-to-window-config-7 "Switch to workspace 7")
      ("8" eyebrowse-switch-to-window-config-8 "Switch to workspace 8")
      ("9" eyebrowse-switch-to-window-config-9 "Switch To Workspace 9")
      ("d" eyebrowse-close-window-config "Delete this workspace")
      ("c" eyebrowse-create-window-config "Create New Workspace")))
...
#+BEGIN_SRC emacs-lisp
  (use-package go-mode
    ...
    (defun amirreza/go-hook ()
      ...
      (define-key go-mode-map (kbd "C-c m g t") 'amirreza/snippet-go-tf)
      (define-key go-mode-map (kbd "C-c m g h") 'amirreza/snippet-go-hh)
      (define-key go-mode-map (kbd "C-c m g f") 'amirreza/snippet-go-for)
      (define-key go-mode-map (kbd "C-c m g i") 'amirreza/snippet-go-if)
      (define-key go-mode-map (kbd "C-c m g p l")  'amirreza/snippet-go-pl)
      (define-key go-mode-map (kbd "C-c m g p f")  'amirreza/snippet-go-pf)
