...
#+begin_src emacs-lisp
  (use-package which-key
    ...
    (which-key! "SPC f" "find things")
    (which-key! "SPC i" "Integrated Tools")
    (which-key! "SPC l" "LSP related things")
    (which-key! "SPC g" "Git related function")
    (which-key! "SPC w" "Workspaces")
    (which-key! "C-c i" "Integrated functionalities")
    (which-key! "C-c i m" "Music functions")
    (which-key! "C-c m" "MajorMode related functionality")
    (which-key! "C-c l" "LSP related functionality")
    (which-key! "C-c g" "Git related functionality")
    (which-key! "C-c f" "File finder")
...
#+begin_src emacs-lisp
  ...
  (use-package evil-collection :straight t :config
    (evil-collection-init (list
                           'dired
                           'magit
                          'ivy
                          'ibuffer
...
#+begin_src emacs-lisp
  ...
  (setq-default mode-line-format
                (list
                 " Workspace:"
                 '(:eval (format "%d" (eyebrowse--get 'current-slot)))
                 "  "
                 mode-line-modified
                 " "
                 mode-line-mule-info
...
#+BEGIN_SRC emacs-lisp
  (use-package eyebrowse 
    ...
    (space-leader "w 1" 'eyebrowse-switch-to-window-config-1)
    (space-leader "w 2" 'eyebrowse-switch-to-window-config-2)
    (space-leader "w 3" 'eyebrowse-switch-to-window-config-3)
    (space-leader "w 4" 'eyebrowse-switch-to-window-config-4)
    (space-leader "w 5" 'eyebrowse-switch-to-window-config-5)
    (space-leader "w 6" 'eyebrowse-switch-to-window-config-6)
    (space-leader "w 7" 'eyebrowse-switch-to-window-config-7)
    (space-leader "w 8" 'eyebrowse-switch-to-window-config-8)
    (space-leader "w 9" 'eyebrowse-switch-to-window-config-9)
    (space-leader "w d" 'eyebrowse-close-window-config)
    (space-leader "w c" 'eyebrowse-create-window-config)
...
#+begin_src emacs-lisp
  (use-package project
    :general
    (space-leader "f p" 'amirreza/find-project)
...
#+begin_src emacs-lisp
  ...
  (use-package project
    :general
    (space-leader
      "SPC" 'amirreza/file-finder
      "f t" 'amirreza/grep
      "f a s" 'amirreza/find-symbol-at-point
      "f a f" 'amirreza/find-file-at-point)
...
#+begin_src emacs-lisp
  (use-package abbrev :init (setq save-abbrevs 'silent) :commands (expand-abbrev))
  ...
  (use-package lsp-mode :straight t
    ...
    :hook ((prog-mode . lsp)
      ...
      (use-package lsp-ivy :after ivy :commands lsp-ivy-workspace-symbol
        ...
        :general (space-leader "l f s" 'lsp-ivy-workspace-symbol))
#+end_src
** Rainbow delimiters
#+begin_src emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package git-messenger
    ...
    :general
    (space-leader "g m" 'git-messenger:popup-message)
    :bind
...
#+begin_src emacs-lisp
  (defvar amirreza/dotfiles-location (concat (getenv "HOME") "/src/" "dotfiles") "Location of my dotfiles.")
  ...
  (space-leader "f c" 'amirreza/edit-dot-config)
#+end_src
* Depreacated
** Icomplete
:PROPERTIES:
