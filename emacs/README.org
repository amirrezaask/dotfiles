...
** Workspaces
   #+BEGIN_SRC elisp
     (use-package eyebrowse 
       ...
       :bind (("C-!" . eyebrowse-switch-to-window-config-1)
              ("C-@" . eyebrowse-switch-to-window-config-2)
              ("C-#" . eyebrowse-switch-to-window-config-3)
              ("C-$" . eyebrowse-switch-to-window-config-4)
              ("C-%" . eyebrowse-switch-to-window-config-5)
              ("C-^" . eyebrowse-switch-to-window-config-6)
              ("C-&" . eyebrowse-switch-to-window-config-7)
              ("C-M-n" . eyebrowse-next-window-config)
              ("C-M-p" . eyebrowse-previous-window-config)))
   #+END_SRC
** DevOps
   #+begin_src emacs-lisp
