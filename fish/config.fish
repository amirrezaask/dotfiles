...
alias goland='~/jetbrains/GoLand/bin/goland.sh 2>/dev/null  &'
alias clion='~/jetbrains/CLion/bin/clion.sh 2>/dev/null  &'
alias intelij='~/jetbrains/Intelij/bin/intelij.sh 2>/dev/null  &'
alias pycharm='~/jetbrains/PyCharm/bin/pycharm.sh 2>/dev/null  &'
alias pstorm='~/jetbrains/PhpStorm/bin/phpstorm.sh 2>/dev/null  &'
alias webstorm='~/jetbrains/WebStorm/bin/webstorm.sh 2>/dev/null  &'
alias datagrip='~/jetbrains/DataGrip/bin/datagrip.sh 2>/dev/null  &'
