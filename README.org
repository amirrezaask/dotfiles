...
#+BEGIN_SRC emacs-lisp
  (defun amirreza/mac-laptop-mode ()
    (interactive)
    (amirreza/display-mac)
    (amirreza/keyboard-mac)
    )

  (defun amirreza/mac-workstation-mode ()
    (interactive)
    (amirreza/display-benq)
    (amirreza/keyboard-kinesis)
    )
#+END_SRC
** Kitty
*** Themes
