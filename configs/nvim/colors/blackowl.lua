...
local function hl(id, name, def) vim.api.nvim_set_hl(id, name, def) end
...
function theme.set_highlights(options)
  ...
  hl(0, "DiagnosticUnderlineError", { fg = "NONE", bg = "NONE", sp = palette.error_red, undercurl = options.undercurl })
  ...
  hl(0, "NvimTreeWindowPicker", { fg = palette.orange2, bg = palette.dark, bold = options.bold, italic = options.italics })
  ...
  hl(0, "IndentBlanklineContextStart", { fg = "NONE", bg = "NONE", sp = palette.indent_guide_active, underline = options.underline })
