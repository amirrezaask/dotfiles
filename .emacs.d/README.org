...
#+END_SRC
** Side effects
As a functional programming enthusiast I think we should isolate side effects and stateful stuff
...
** Auto completion
#+BEGIN_SRC emacs-lisp
  (config (corfu :type git :host github :repo "emacs-straight/corfu" :files ("*" "extensions/*.el" (:exclude ".git")))
		(setq corfu-auto t)
		(global-corfu-mode)
