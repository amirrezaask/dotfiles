...
end, { desc = "Diff current file with HEAD" })
...
bind("n", "<C-p>", function()
	telescope_builtin.git_files(dropdown(no_preview))
end, { desc = "Telescope Git Files" })
bind("n", "<leader>pf", function()
	telescope_builtin.find_files(dropdown(no_preview))
end, { desc = "Telescope Find files" })
bind("n", "<leader><leader>", function()
	telescope_builtin.find_files(dropdown(no_preview))
end, { desc = "Telescope Find files" })
bind("n", "<C-f>", function()
	telescope_builtin.current_buffer_fuzzy_find(no_preview)
end, { desc = "Current File Search" })
bind("n", "<leader>o", function()
	telescope_builtin.treesitter(dropdown(no_preview))
end, { desc = "Search Symbols In Current File" })
bind("n", "??", function()
	telescope_builtin.live_grep(no_preview)
end, { desc = "Live Grep" })
bind("n", "Q", "<NOP>")
bind("n", "{", ":cprev<CR>")
bind("n", "}", ":cnext<CR>")
...
vim.api.nvim_create_autocmd("LspAttach", {
	callback = function(args)
		...
		bind("n", "<leader>o", function()
			require("telescope.builtin").lsp_document_symbols(dropdown(no_preview))
		end, buffer("Document Symbols"))
	end,
})
