...
-- which will install packer if needed and
-- also registers all plugins to be installed.
-- then all after/plugin/* files get sourced
-- all files under lua/* are just there and need to be sourced manually

-- Some global functions and helpers.
require "core"
-- Packer.nvim installation and plugin registeration.
require "user.packer"
